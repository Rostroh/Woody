...
static void		msg_wrongarch(char *name, char *input)
{
}
...
{
	static void		(*error_msg[NB_ERR])(char *name, char *input) = {&msg_noarg, &msg_noright, &msg_wrongflg, &msg_wrongarch, &msg_other};
